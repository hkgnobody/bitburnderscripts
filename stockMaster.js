...
let commission = 100e3; // Buy/sell commission. Expected profit must exceed this to buy anything.
...
const argsSchema = [
    ...
    ['diversification', 0.25], // Before we have 4S data, we will not hold more than this fraction of our portfolio as a single stock
    ...
    ['pre-4s-sell-threshold-return', 0.0015], // Before we have 4S data, Sell stocks forecasted to earn less than this return (default 0.15% or 15 Basis Points)
